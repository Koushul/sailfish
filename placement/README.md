...
When each well is one **row** oligo and one **column** oligo (no plate combining), see **[README_2barcodes.md](README_2barcodes.md)** for the full HTML / here.now pipeline.

Short version — generate the site:
